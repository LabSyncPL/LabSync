...
namespace LabSync.Core.Dto
{
    ...
    /// <summary>
    /// Server response containing authentication credentials or status.
    /// </summary>
    public class RegisterAgentResponse
    {
        /// <summary>
        /// Unique Device ID generated by the database.
        /// Even if not approved, the device gets an ID.
        /// </summary>
        public Guid DeviceId { get; set; }

        /// <summary>
        /// API Token (JWT) used for authorized requests.
        /// <br/>
        /// <b>NULL</b> if the device is waiting for Administrator approval.
        /// </summary>
        public string? Token { get; set; }

        /// <summary>
        /// Status message from the server (e.g. "Authorized", "Pending Approval", "Blocked").
        /// </summary>
