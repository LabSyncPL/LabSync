...
namespace LabSync.Server.src.LabSync.Server.Migrations
{
    ...
    [Migration("20260520220125_ScheduledScriptArgumentsTextArray")]
    partial class ScheduledScriptArgumentsTextArray
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabSync.Core.Entities.DeviceCredentials", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("UseKeyAuthentication")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("LabSync.Core.Entities.DeviceCredentials", b =>
                {
                    b.HasOne("LabSync.Core.Entities.Device", "Device")
                        .WithOne("Credentials")
                        .HasForeignKey("LabSync.Core.Entities.DeviceCredentials", "DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
