...
public interface IRemoteShellService : IAsyncDisposable
{
    ...
    /// <summary>
    /// Opens an interactive shell session to the remote host.
    /// </summary>
    ...
    Task OpenSessionAsync(string host, string username, string password, string terminalName = "xterm", uint columns = 80, uint rows = 24, CancellationToken cancellationToken = default);
